...
###### String（字符串）：字符串，最基本的数据类型，二进制安全的字符串，最大512M。

###### Hash（哈希，类似java里的Map）：散列表，2^32-1

###### List（列表）：列表，按添加顺序保持顺序的字符串列表，2^32-1

###### Set（集合）：无序集合，2^32-1

###### Zset(sorted set：有序集合)：有序集合，2^32-1
...
<img src="../../java-senior-pro/resource/redis-String结构.png" style="zoom:60%;" />
...
<img src="../../java-senior-pro/resource/redis_quicklist_structure.png" style="zoom:16%;" />
...
<img src="../../java-senior-pro/resource/redis-skiplist-structure.png" style="zoom:67%;" />
